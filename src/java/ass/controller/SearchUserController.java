...
public class SearchUserController extends HttpServlet {
    ...
    public static final String ERROR = "userList.jsp";
    public static final String SUCCESS = "userList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<UserDTO> listUser = uDao.getListUser(searchUser);
            
            if(listUser != null ){
                session.setAttribute("LIST_USER", listUser);
                url = SUCCESS;
            }else{
                session.setAttribute("ERROR_MESSAGE", "Not found!");
            }
