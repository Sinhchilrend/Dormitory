...
<div class="container">
    <div class="left">
        <ul class="left_menu">
            ...
            <a href="listRoom.jsp?floor=1&dorm=A" target="target">
                <li class="myRoom ">
            ...
            <a href="history.jsp" target="target">
                <li class="pay">
                    <i class="fa-sharp fa-solid fa-credit-card iconCss"></i>
                    <span>History</span>
                </li>
            ...
            <a href="history.jsp" target="target">
                ...
                <% if (loginUser != null) {%>
            <a href="MainController?action=listRegistRoom&status=RG&role=<%= loginUser.getRole()%>&userId=<%= loginUser.getUserId()%>" target="target">
                <li class="pay">
                    <i class="fa-sharp fa-solid fa-credit-card iconCss"></i>
                    <span>Regist</span>
                </li>
